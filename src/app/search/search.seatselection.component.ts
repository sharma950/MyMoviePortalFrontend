...
import { SearchCityComponent } from './search.component';
...
@Component({
    ...
    templateUrl: '../search/search.seatselection.html',
    styleUrls: ['../search/search.seatselection.css','../search/seat.css'],
    inputs:[`seatBooking`]
})
export class SeatSelectionComponent implements OnInit {
    ...
    searchCity: SearchCityComponent;
    ...
    ngOnInit() {
        this.seatBooking=this.seatBooking.getSeatData;
